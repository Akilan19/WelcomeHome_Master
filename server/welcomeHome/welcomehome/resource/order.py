...
class Inventory(Resource):
    def get(self):
        ...
        current_order=OrderUtils.get_order_with_orderid_or_clientid(OrderID=request.args.get("OrderID",None),
